...
const serviceLists = [
    ...
    {id:3, title: "Online Ordering", des: "Explore menu & order with ease using our Online Ordering n", img: "../../public/images/home/services/icon3.png"},
...
const Ourservec = () => {
    return (
        <div className="secetion-container my-16">
                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                    {
                        serviceLists.map((service) => (
                            <div key={service.id} className="shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:border hover:border-indigo-600 transition-all duration-300">
